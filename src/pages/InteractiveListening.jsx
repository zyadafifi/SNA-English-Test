...
import { init } from '../legacy/interactive-listening.legacy'
import { getNextQuizUrl } from '../legacy/skills-config.legacy'
import './styles/interactive-listening.css'

export default function InteractiveListening() {
      ...
      <div className="quiz-container" id="quizContainer" style={{ display: 'none' }}>
        <div className="question-card" id="questionCard">
          ...
          <div className="stage-progress-bar">
            ...
            <span className="progress-text" id="stageProgressText">0/8</span>
          </div>
          <div className="question-content" id="questionContent">
            <h1 className="question-title" id="questionTitle">Listen and answer</h1>
            <div className="passage-container" id="passageContainer" />
            <div className="audio-area">
              <button type="button" className="play-button" id="playButton">PLAY</button>
              <div className="audio-waveform" id="audioWaveform" />
              <div className="audio-status" id="audioStatus" style={{ display: 'none' }} />
            </div>
            <div id="questionsSection" />
            <button type="button" className="submit-btn" id="submitBtn">CONTINUE</button>
            <button type="button" className="continue-btn" id="continueBtn" style={{ display: 'none' }}>NEXT</button>
          </div>
        </div>
        <div className="feedback-section" id="feedbackSection">
          ...
          <div className="correct-answer-text" id="feedbackDetails" />
        </div>
