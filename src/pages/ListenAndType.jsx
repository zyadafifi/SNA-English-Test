...
import { init } from '../legacy/listen-and-type.legacy'
...
export default function ListenAndType() {
  ...
  const waveformBars = Array.from({ length: 40 }, (_, i) => <div key={i} className="waveform-bar" />)

  return (
    <div className="listen-and-type-page" ref={rootRef}>
      ...
      <div className="quiz-container" id="quizContainer" style={{ display: 'none' }}>
        <div className="question-card" id="questionCard">
          <div className="timer" id="timer">
            ...
            <span className="timer-suffix">for this question</span>
          </div>
          ...
          <div className="question-content" id="questionContent">
            <h1 className="question-title" id="questionTitle">Listen to the sentence and answer</h1>
            <div className="audio-status" id="audioStatus" style={{ display: 'none' }} />
            <div className="audio-player">
              <div className="audio-player-bar">
                <div className="audio-tooltip" id="audioTooltip">tap here to listen</div>
                <button type="button" className="play-button" id="playButton">
                ...
                <button type="button" className="speed-control" id="speedControl">1x</button>
              </div>
            </div>
            <div className="text-input-container">
              <textarea className="text-input" id="textInput" placeholder="Type what you hear..." maxLength={500} />
            </div>
            <button type="button" className="submit-btn" id="submitBtn">SUBMIT</button>
          </div>
        </div>
        ...
        <div className="results-screen" id="resultsScreen">
          ...
          <div className="results-subtitle">improved your listening skills.</div>
