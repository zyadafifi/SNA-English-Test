...
import { init } from '../legacy/read-and-select.legacy'
import { getNextQuizUrl } from '../legacy/skills-config.legacy'
import './styles/read-and-select.css'
      ...
      <div className="quiz-container" id="quizContainer" style={{ display: 'none' }}>
        <div className="question-card" id="questionCard">
          ...
          <div className="stage-progress-bar">
            ...
            <span className="progress-text" id="stageProgressText">0/20</span>
          </div>

          <div className="question-content" id="questionContent">
            <h1 className="question-title" id="questionTitle">
              is this a rel english word?
            </h1>
            <div className="word-display" id="wordDisplay">Loading...</div>

            <div className="answer-buttons">
              <button type="button" className="answer-btn" id="yesBtn">
                Yes
              </button>
              <button type="button" className="answer-btn" id="noBtn">
                No
              </button>
            </div>
          </div>
