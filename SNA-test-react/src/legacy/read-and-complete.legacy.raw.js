// Quiz Data (will be loaded from JSON)
      ...
      async function loadQuizData() {
        try {
          ...
          const response = await fetch("read and complete data.json");
          if (!response.ok) {
      ...
      function startQuestionTimer() {
        ...
        timerInterval = setInterval(() => {
          ...
          // Warning color after 2 minutes 30 seconds (150 seconds)
          if (seconds >= 150) {
      ...
      function showResults() {
        ...
        if (continueBtn) {
          ...
          const hasNextQuiz = typeof getNextQuizUrl === "function" && getNextQuizUrl("Read and Complete");
      ...
      function continueToNextStage() {
        if (stagesCompletedThisSession >= STAGES_TOTAL && typeof getNextQuizUrl === "function") {
          const nextUrl = getNextQuizUrl("Read and Complete");
          if (nextUrl) {
