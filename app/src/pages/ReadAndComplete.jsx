...
import { init } from '../legacy/read-and-complete.legacy'
import { getNextQuizUrl } from '../legacy/skills-config.legacy'
import './styles/read-and-complete.css'

export default function ReadAndComplete() {
        ...
        <div className="question-card" id="questionCard">
          ...
          <div className="question-content" id="questionContent">
            ...
            <div className="passage-section">
              <div className="passage-title" id="passageTitle">Passage Title</div>
              <div className="passage-container" id="passageContainer">
                {/* Passage generated by legacy */}
              </div>
            </div>
