// Quiz Data (will be loaded from JSON)
      ...
      async function loadQuizData() {
        try {
          ...
          const response = await fetch("interactive reading data.json");
          if (!response.ok) {
      ...
      function showQuestion() {
        ...
        document.getElementById("passageTitle").textContent = "PASSAGE";
      ...
      function createQuestionItem(questionData, index) {
        ...
        label.textContent = "Select a word";
      ...
      function handleDropdownChange(
        ...
        const blankSpace = document.querySelector(
      ...
      function startQuestionTimer() {
        ...
        timerInterval = setInterval(() => {
          ...
          // Warning color after 5 minutes (300 seconds)
          if (seconds >= 300) {
      ...
      function showResults() {
        ...
        if (continueBtn) {
          ...
          const hasNextQuiz = typeof getNextQuizUrl === "function" && getNextQuizUrl("Interactive Reading");
      ...
      function continueToNextStage() {
        if (stagesCompletedThisSession >= STAGES_TOTAL && typeof getNextQuizUrl === "function") {
          const nextUrl = getNextQuizUrl("Interactive Reading");
          if (nextUrl) {
